...
async function main() {
  ...
  const baseBridgeSdk: ArbitrumBaseBridgeSdk = {
    ...
    l1GovRelay: rinkebySdk.arbitrumDaiBridge.l1GovernanceRelay as any, // @todo: due to a problem in eth-sdk daiBridge.l1GovernanceRelay has L1OptimismGovernanceRelay type...
    ...
    l2GovRelay: arbitrumTestnetSdk.arbitrumDaiBridge.l2GovernanceRelay as any, // @todo: due to a problem in eth-sdk daiBridge.l2GovernanceRelay has L2OptimismGovernanceRelay type...
