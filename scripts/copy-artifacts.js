...
copyHardhatArtifact(join(hardhatOptimismBridgeArtifacts, 'l1/L1GovernanceRelay.sol/L1GovernanceRelay.json'), output)
...
copyHardhatArtifact(join(hardhatOptimismBridgeArtifacts, 'l2/L2GovernanceRelay.sol/L2GovernanceRelay.json'), output)
